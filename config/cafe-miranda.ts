...
export const cafeConfig = {
  ...
  favoritos: [
    ...
    {
      name: "Milhoja de Bacalao",
      description: "Capas de bacalao desmenuzado, masa crujiente y salsa roja. Tapa con personalidad propia.",
      price: "9,50€",
      image: "/images/tapa-bacalao.jpg",
      badge: "Tapa estrella",
    },
    {
      name: "Brioche con Jamón",
      description: "Brioche artesanal, jamón ibérico, queso crema y brotes. Simple en la lista, memorable en el paladar.",
      price: "11,00€",
    ...
    },
    {
      ...
      description: "Berenjena a la brasa con yogur, nueces y granada. Un plato que sorprende siempre.",
      price: "8,00€",
    ...
    },
    {
      ...
      description: "Tortilla de maíz, pescado crujiente y mayonesa de chipotle. Los tacos que no esperabas en Formentera.",
      price: "10,00€",
    ...
    },
    {
      ...
      description: "Bodega cuidada, vinos con historia. Porque a veces el brunch necesita una copa.",
      price: "desde 6€",
